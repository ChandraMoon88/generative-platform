...
function Level15Visionary({ progress, setProgress }: { progress: GameProgress; setProgress: (p: GameProgress) => void }) {
  ...
  const [partnerships, setPartnerships] = useState(new Map([
    ['partner-1', { id: 'partner-1', name: 'Global Water Foundation', type: 'NGO', status: 'initial' as 'initial' | 'engaged' | 'committed' | 'strategic' | 'collaborating', funding: 0 }],
    ['partner-2', { id: 'partner-2', name: 'EcoTech Solutions', type: 'Corporate', status: 'initial' as 'initial' | 'engaged' | 'committed' | 'strategic' | 'collaborating', funding: 0 }],
    ['partner-3', { id: 'partner-3', name: 'International Rivers Network', type: 'Network', status: 'initial' as 'initial' | 'engaged' | 'committed' | 'strategic' | 'collaborating', funding: 0 }],
  ]));
